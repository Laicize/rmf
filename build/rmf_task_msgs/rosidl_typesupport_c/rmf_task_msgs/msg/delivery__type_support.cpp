...
#include "rmf_task_msgs/msg/detail/delivery__type_support.h"
...
static const _Delivery_type_support_symbol_names_t _Delivery_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_task_msgs, msg, Delivery)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_task_msgs, msg, Delivery)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rmf_task_msgs, msg, Delivery)() {
  return &::rmf_task_msgs::msg::rosidl_typesupport_c::Delivery_message_type_support_handle;
}
