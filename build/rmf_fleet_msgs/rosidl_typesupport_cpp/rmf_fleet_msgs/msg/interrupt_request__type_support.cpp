...
static const _InterruptRequest_type_support_symbol_names_t _InterruptRequest_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rmf_fleet_msgs, msg, InterruptRequest)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rmf_fleet_msgs, msg, InterruptRequest)),
  }
};
...
{
  return &::rmf_fleet_msgs::msg::rosidl_typesupport_cpp::InterruptRequest_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rmf_fleet_msgs, msg, InterruptRequest)() {
  return get_message_type_support_handle<rmf_fleet_msgs::msg::InterruptRequest>();
}
