...
#include "rmf_obstacle_msgs/msg/detail/obstacles__rosidl_typesupport_fastrtps_c.h"
...
#include "rmf_obstacle_msgs/msg/detail/obstacle__functions.h"  // obstacles
...
using _Obstacles__ros_msg_type = rmf_obstacle_msgs__msg__Obstacles;
  ...
  // Field name: obstacles
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, rmf_obstacle_msgs, msg, Obstacle
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: obstacles
  {
    ...
    if (ros_message->obstacles.data) {
      rmf_obstacle_msgs__msg__Obstacle__Sequence__fini(&ros_message->obstacles);
    }
    if (!rmf_obstacle_msgs__msg__Obstacle__Sequence__init(&ros_message->obstacles, size)) {
  ...
  size_t current_alignment)
{
  ...
  // field.name obstacles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_rmf_obstacle_msgs__msg__Obstacle(
...
static uint32_t _Obstacles__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_obstacle_msgs__msg__Obstacles(
  ...
  size_t current_alignment)
{
  ...
  // member: obstacles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_rmf_obstacle_msgs__msg__Obstacle(
...
static size_t _Obstacles__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmf_obstacle_msgs__msg__Obstacles(
