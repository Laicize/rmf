...
#include "rmf_traffic_msgs/msg/detail/schedule_change_add_item__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rmf_traffic_msgs::msg::ScheduleChangeAddItem & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rmf_traffic_msgs::msg::ScheduleChangeAddItem & ros_message)
{
  // Member: route_id
  cdr >> ros_message.route_id;
...
{
  auto typed_message =
    static_cast<const rmf_traffic_msgs::msg::ScheduleChangeAddItem *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rmf_traffic_msgs::msg::ScheduleChangeAddItem *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ScheduleChangeAddItem__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rmf_traffic_msgs::msg::ScheduleChangeAddItem *>(
...
static size_t _ScheduleChangeAddItem__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ScheduleChangeAddItem(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ScheduleChangeAddItem__callbacks = {
...
static rosidl_message_type_support_t _ScheduleChangeAddItem__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ScheduleChangeAddItem__callbacks,
...
{
  return &rmf_traffic_msgs::msg::typesupport_fastrtps_cpp::_ScheduleChangeAddItem__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rmf_traffic_msgs, msg, ScheduleChangeAddItem)() {
  return &rmf_traffic_msgs::msg::typesupport_fastrtps_cpp::_ScheduleChangeAddItem__handle;
}
