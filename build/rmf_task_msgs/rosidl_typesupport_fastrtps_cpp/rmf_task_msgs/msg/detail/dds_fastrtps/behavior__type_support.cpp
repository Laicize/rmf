...
#include "rmf_task_msgs/msg/detail/behavior__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const rmf_task_msgs::msg::BehaviorParameter &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  rmf_task_msgs::msg::BehaviorParameter &);
  ...
  size_t current_alignment)
{
  ...
  // Member: parameters
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        rmf_task_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_BehaviorParameter(
...
{
  auto typed_message =
    static_cast<const rmf_task_msgs::msg::Behavior *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rmf_task_msgs::msg::Behavior *>(
    untyped_ros_message);
...
{
  return &rmf_task_msgs::msg::typesupport_fastrtps_cpp::_Behavior__handle;
}
