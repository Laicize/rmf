...
#include "rmf_workcell_msgs/msg/detail/trait__rosidl_typesupport_fastrtps_c.h"
...
using _Trait__ros_msg_type = rmf_workcell_msgs__msg__Trait;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Trait__ros_msg_type * ros_message = static_cast<const _Trait__ros_msg_type *>(untyped_ros_message);
  // Field name: key
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Trait__ros_msg_type * ros_message = static_cast<_Trait__ros_msg_type *>(untyped_ros_message);
  // Field name: key
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _Trait__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_workcell_msgs__msg__Trait(
...
static size_t _Trait__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmf_workcell_msgs__msg__Trait(
...
static message_type_support_callbacks_t __callbacks_Trait = {
...
static rosidl_message_type_support_t _Trait__type_support = {
