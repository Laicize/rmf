...
#define NODE_MAIN_LOGGER_NAME "schedule_visualizer_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libschedule_visualizer.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ScheduleVisualizer>";
