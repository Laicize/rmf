...
#include "rmf_fleet_msgs/msg/detail/path_request__rosidl_typesupport_fastrtps_c.h"
...
using _PathRequest__ros_msg_type = rmf_fleet_msgs__msg__PathRequest;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _PathRequest__ros_msg_type * ros_message = static_cast<const _PathRequest__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _PathRequest__ros_msg_type * ros_message = static_cast<_PathRequest__ros_msg_type *>(untyped_ros_message);
  // Field name: fleet_name
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _PathRequest__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_fleet_msgs__msg__PathRequest(
...
static size_t _PathRequest__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmf_fleet_msgs__msg__PathRequest(
...
static message_type_support_callbacks_t __callbacks_PathRequest = {
  "rmf_fleet_msgs::msg",
  "PathRequest",
