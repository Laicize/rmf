...
static const _GraphEdge_type_support_symbol_names_t _GraphEdge_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rmf_building_map_msgs, msg, GraphEdge)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rmf_building_map_msgs, msg, GraphEdge)),
  }
};
...
{
  return &::rmf_building_map_msgs::msg::rosidl_typesupport_cpp::GraphEdge_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rmf_building_map_msgs, msg, GraphEdge)() {
  return get_message_type_support_handle<rmf_building_map_msgs::msg::GraphEdge>();
}
