...
#include "rmf_traffic_msgs/srv/detail/unregister_participant__type_support.h"
...
static const _UnregisterParticipant_Request_type_support_symbol_names_t _UnregisterParticipant_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_traffic_msgs, srv, UnregisterParticipant_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_traffic_msgs, srv, UnregisterParticipant_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rmf_traffic_msgs, srv, UnregisterParticipant_Request)() {
  return &::rmf_traffic_msgs::srv::rosidl_typesupport_c::UnregisterParticipant_Request_message_type_support_handle;
}
...
static const _UnregisterParticipant_Response_type_support_symbol_names_t _UnregisterParticipant_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_traffic_msgs, srv, UnregisterParticipant_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_traffic_msgs, srv, UnregisterParticipant_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rmf_traffic_msgs, srv, UnregisterParticipant_Response)() {
  return &::rmf_traffic_msgs::srv::rosidl_typesupport_c::UnregisterParticipant_Response_message_type_support_handle;
}
...
static const _UnregisterParticipant_type_support_symbol_names_t _UnregisterParticipant_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_traffic_msgs, srv, UnregisterParticipant)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_traffic_msgs, srv, UnregisterParticipant)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, rmf_traffic_msgs, srv, UnregisterParticipant)() {
  return &::rmf_traffic_msgs::srv::rosidl_typesupport_c::UnregisterParticipant_service_type_support_handle;
}
