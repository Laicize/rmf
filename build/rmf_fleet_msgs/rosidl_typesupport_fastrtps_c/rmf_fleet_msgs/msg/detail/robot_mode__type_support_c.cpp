...
#include "rmf_fleet_msgs/msg/detail/robot_mode__rosidl_typesupport_fastrtps_c.h"
...
using _RobotMode__ros_msg_type = rmf_fleet_msgs__msg__RobotMode;
...
static uint32_t _RobotMode__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_fleet_msgs__msg__RobotMode(
...
static size_t _RobotMode__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmf_fleet_msgs__msg__RobotMode(
