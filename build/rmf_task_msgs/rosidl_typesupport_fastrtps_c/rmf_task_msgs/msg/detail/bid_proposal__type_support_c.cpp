...
#include "rmf_task_msgs/msg/detail/bid_proposal__rosidl_typesupport_fastrtps_c.h"
...
#include "builtin_interfaces/msg/detail/time__functions.h"  // finish_time
...
using _BidProposal__ros_msg_type = rmf_task_msgs__msg__BidProposal;

static bool _BidProposal__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _BidProposal__ros_msg_type * ros_message = static_cast<const _BidProposal__ros_msg_type *>(untyped_ros_message);
  ...
  {
    cdr << ros_message->prev_cost;
  }

  // Field name: new_cost
  {
    cdr << ros_message->new_cost;
  }
...
static bool _BidProposal__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _BidProposal__ros_msg_type * ros_message = static_cast<_BidProposal__ros_msg_type *>(untyped_ros_message);
  // Field name: fleet_name
  {
    std::string tmp;
    cdr >> tmp;
  ...
  size_t current_alignment)
{
  ...
  // field.name prev_cost
  {
    size_t item_size = sizeof(ros_message->prev_cost);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name new_cost
  {
    size_t item_size = sizeof(ros_message->new_cost);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name finish_time
  ...
  current_alignment += get_serialized_size_builtin_interfaces__msg__Time(
    &(ros_message->finish_time), current_alignment);

  return current_alignment - initial_alignment;
}

static uint32_t _BidProposal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_task_msgs__msg__BidProposal(
...
static size_t _BidProposal__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_rmf_task_msgs__msg__BidProposal(
...
static message_type_support_callbacks_t __callbacks_BidProposal = {
  "rmf_task_msgs::msg",
  "BidProposal",
  _BidProposal__cdr_serialize,
  _BidProposal__cdr_deserialize,
  _BidProposal__get_serialized_size,
  _BidProposal__max_serialized_size
};

static rosidl_message_type_support_t _BidProposal__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_BidProposal,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_task_msgs, msg, BidProposal)() {
  return &_BidProposal__type_support;
}
