...
#include "rmf_traffic_msgs/msg/detail/schedule_change_delay__rosidl_typesupport_fastrtps_c.h"
...
using _ScheduleChangeDelay__ros_msg_type = rmf_traffic_msgs__msg__ScheduleChangeDelay;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ScheduleChangeDelay__ros_msg_type * ros_message = static_cast<const _ScheduleChangeDelay__ros_msg_type *>(untyped_ros_message);
  // Field name: delay
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ScheduleChangeDelay__ros_msg_type * ros_message = static_cast<_ScheduleChangeDelay__ros_msg_type *>(untyped_ros_message);
  // Field name: delay
  {
    cdr >> ros_message->delay;
  }
...
static uint32_t _ScheduleChangeDelay__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_traffic_msgs__msg__ScheduleChangeDelay(
...
static size_t _ScheduleChangeDelay__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmf_traffic_msgs__msg__ScheduleChangeDelay(
...
static message_type_support_callbacks_t __callbacks_ScheduleChangeDelay = {
...
static rosidl_message_type_support_t _ScheduleChangeDelay__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ScheduleChangeDelay,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_traffic_msgs, msg, ScheduleChangeDelay)() {
  return &_ScheduleChangeDelay__type_support;
}
