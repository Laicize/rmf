...
#include "rmf_building_map_msgs/msg/detail/building_map__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const rmf_building_map_msgs::msg::Level &,
...
{
bool cdr_serialize(
  const rmf_building_map_msgs::msg::Lift &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  rmf_building_map_msgs::msg::BuildingMap & ros_message)
{
  ...
  // Member: lifts
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    ros_message.lifts.resize(size);
    for (size_t i = 0; i < size; i++) {
      rmf_building_map_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.lifts[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: lifts
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        rmf_building_map_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.lifts[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: levels
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        rmf_building_map_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Level(
  ...
  // Member: lifts
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        rmf_building_map_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Lift(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
{
  auto typed_message =
    static_cast<const rmf_building_map_msgs::msg::BuildingMap *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rmf_building_map_msgs::msg::BuildingMap *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BuildingMap__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rmf_building_map_msgs::msg::BuildingMap *>(
...
static size_t _BuildingMap__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_BuildingMap(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _BuildingMap__callbacks = {
...
static rosidl_message_type_support_t _BuildingMap__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_BuildingMap__callbacks,
...
{
  return &rmf_building_map_msgs::msg::typesupport_fastrtps_cpp::_BuildingMap__handle;
}
