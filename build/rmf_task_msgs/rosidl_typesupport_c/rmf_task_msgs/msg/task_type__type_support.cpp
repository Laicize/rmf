...
#include "rmf_task_msgs/msg/detail/task_type__type_support.h"
...
static const _TaskType_type_support_symbol_names_t _TaskType_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_task_msgs, msg, TaskType)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_task_msgs, msg, TaskType)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rmf_task_msgs, msg, TaskType)() {
  return &::rmf_task_msgs::msg::rosidl_typesupport_c::TaskType_message_type_support_handle;
}
