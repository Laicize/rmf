...
#include "rmf_door_msgs/msg/detail/door_mode__rosidl_typesupport_fastrtps_c.h"
...
using _DoorMode__ros_msg_type = rmf_door_msgs__msg__DoorMode;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _DoorMode__ros_msg_type * ros_message = static_cast<const _DoorMode__ros_msg_type *>(untyped_ros_message);
  // Field name: value
  {
  ...
  void * untyped_ros_message)
{
  ...
  _DoorMode__ros_msg_type * ros_message = static_cast<_DoorMode__ros_msg_type *>(untyped_ros_message);
  // Field name: value
  {
    cdr >> ros_message->value;
  }
...
static uint32_t _DoorMode__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_door_msgs__msg__DoorMode(
...
static size_t _DoorMode__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmf_door_msgs__msg__DoorMode(
...
static message_type_support_callbacks_t __callbacks_DoorMode = {
  "rmf_door_msgs::msg",
  "DoorMode",
