...
#include "rmf_traffic_msgs/msg/detail/itinerary_set__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const rmf_traffic_msgs::msg::ItinerarySet *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rmf_traffic_msgs::msg::ItinerarySet *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ItinerarySet__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rmf_traffic_msgs::msg::ItinerarySet *>(
...
static size_t _ItinerarySet__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ItinerarySet(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ItinerarySet__callbacks = {
...
static rosidl_message_type_support_t _ItinerarySet__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ItinerarySet__callbacks,
...
{
  return &rmf_traffic_msgs::msg::typesupport_fastrtps_cpp::_ItinerarySet__handle;
}
