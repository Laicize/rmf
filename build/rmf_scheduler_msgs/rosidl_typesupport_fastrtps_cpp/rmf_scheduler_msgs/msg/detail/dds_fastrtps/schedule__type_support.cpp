...
#include "rmf_scheduler_msgs/msg/detail/schedule__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rmf_scheduler_msgs::msg::Schedule & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rmf_scheduler_msgs::msg::Schedule & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
...
{
  auto typed_message =
    static_cast<const rmf_scheduler_msgs::msg::Schedule *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rmf_scheduler_msgs::msg::Schedule *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Schedule__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rmf_scheduler_msgs::msg::Schedule *>(
...
static size_t _Schedule__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Schedule(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Schedule__callbacks = {
...
static rosidl_message_type_support_t _Schedule__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Schedule__callbacks,
...
{
  return &rmf_scheduler_msgs::msg::typesupport_fastrtps_cpp::_Schedule__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rmf_scheduler_msgs, msg, Schedule)() {
  return &rmf_scheduler_msgs::msg::typesupport_fastrtps_cpp::_Schedule__handle;
}
