...
#include "rmf_traffic_msgs/msg/detail/participant__rosidl_typesupport_fastrtps_c.h"
...
using _Participant__ros_msg_type = rmf_traffic_msgs__msg__Participant;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Participant__ros_msg_type * ros_message = static_cast<const _Participant__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr << ros_message->id;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _Participant__ros_msg_type * ros_message = static_cast<_Participant__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr >> ros_message->id;
  }
...
static uint32_t _Participant__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_traffic_msgs__msg__Participant(
...
static size_t _Participant__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmf_traffic_msgs__msg__Participant(
...
static message_type_support_callbacks_t __callbacks_Participant = {
