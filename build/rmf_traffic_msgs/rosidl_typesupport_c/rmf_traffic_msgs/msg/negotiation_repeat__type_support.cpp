...
#include "rmf_traffic_msgs/msg/detail/negotiation_repeat__type_support.h"
...
static const _NegotiationRepeat_type_support_symbol_names_t _NegotiationRepeat_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_traffic_msgs, msg, NegotiationRepeat)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_traffic_msgs, msg, NegotiationRepeat)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rmf_traffic_msgs, msg, NegotiationRepeat)() {
  return &::rmf_traffic_msgs::msg::rosidl_typesupport_c::NegotiationRepeat_message_type_support_handle;
}
