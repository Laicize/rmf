...
#include "rmf_door_msgs/msg/detail/session__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // requester_id
#include "rosidl_runtime_c/string_functions.h"  // requester_id
...
using _Session__ros_msg_type = rmf_door_msgs__msg__Session;

static bool _Session__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Session__ros_msg_type * ros_message = static_cast<const _Session__ros_msg_type *>(untyped_ros_message);
...
static bool _Session__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _Session__ros_msg_type * ros_message = static_cast<_Session__ros_msg_type *>(untyped_ros_message);
  // Field name: request_time
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _Session__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_door_msgs__msg__Session(
...
static size_t _Session__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_rmf_door_msgs__msg__Session(
...
static message_type_support_callbacks_t __callbacks_Session = {
  "rmf_door_msgs::msg",
  "Session",
  _Session__cdr_serialize,
  _Session__cdr_deserialize,
  _Session__get_serialized_size,
  _Session__max_serialized_size
};

static rosidl_message_type_support_t _Session__type_support = {
