...
#include "rmf_fleet_msgs/msg/detail/dock__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const rmf_fleet_msgs::msg::DockParameter &,
  ...
  size_t current_alignment)
{
  ...
  // Member: params
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        rmf_fleet_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_DockParameter(
...
{
  auto typed_message =
    static_cast<const rmf_fleet_msgs::msg::Dock *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rmf_fleet_msgs::msg::Dock *>(
    untyped_ros_message);
...
{
  return &rmf_fleet_msgs::msg::typesupport_fastrtps_cpp::_Dock__handle;
}
