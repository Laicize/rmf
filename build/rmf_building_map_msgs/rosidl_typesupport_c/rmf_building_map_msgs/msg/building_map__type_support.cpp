...
#include "rmf_building_map_msgs/msg/detail/building_map__type_support.h"
...
static const _BuildingMap_type_support_symbol_names_t _BuildingMap_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_building_map_msgs, msg, BuildingMap)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_building_map_msgs, msg, BuildingMap)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rmf_building_map_msgs, msg, BuildingMap)() {
  return &::rmf_building_map_msgs::msg::rosidl_typesupport_c::BuildingMap_message_type_support_handle;
}
