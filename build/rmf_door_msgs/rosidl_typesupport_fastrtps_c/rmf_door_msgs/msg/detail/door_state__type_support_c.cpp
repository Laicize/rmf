...
#include "rmf_door_msgs/msg/detail/door_state__rosidl_typesupport_fastrtps_c.h"
...
#include "builtin_interfaces/msg/detail/time__functions.h"  // door_time
#include "rmf_door_msgs/msg/detail/door_mode__functions.h"  // current_mode
...
using _DoorState__ros_msg_type = rmf_door_msgs__msg__DoorState;
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_builtin_interfaces__msg__Time(
    &(ros_message->door_time), current_alignment);
  // field.name door_name
  ...
  current_alignment += get_serialized_size_rmf_door_msgs__msg__DoorMode(
    &(ros_message->current_mode), current_alignment);
...
static uint32_t _DoorState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_door_msgs__msg__DoorState(
...
static size_t _DoorState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmf_door_msgs__msg__DoorState(
