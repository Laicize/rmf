...
#include "rmf_fleet_msgs/msg/detail/speed_limit_request__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rmf_fleet_msgs::msg::SpeedLimitRequest & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rmf_fleet_msgs::msg::SpeedLimitRequest & ros_message)
{
  // Member: fleet_name
  cdr >> ros_message.fleet_name;
  ...
  size_t current_alignment)
{
  ...
  // Member: remove_limits
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.remove_limits[0]);
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rmf_fleet_msgs
max_serialized_size_SpeedLimitRequest(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const rmf_fleet_msgs::msg::SpeedLimitRequest *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rmf_fleet_msgs::msg::SpeedLimitRequest *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SpeedLimitRequest__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rmf_fleet_msgs::msg::SpeedLimitRequest *>(
...
static size_t _SpeedLimitRequest__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SpeedLimitRequest(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SpeedLimitRequest__callbacks = {
  "rmf_fleet_msgs::msg",
  "SpeedLimitRequest",
...
static rosidl_message_type_support_t _SpeedLimitRequest__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SpeedLimitRequest__callbacks,
...
{
  return &rmf_fleet_msgs::msg::typesupport_fastrtps_cpp::_SpeedLimitRequest__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rmf_fleet_msgs, msg, SpeedLimitRequest)() {
  return &rmf_fleet_msgs::msg::typesupport_fastrtps_cpp::_SpeedLimitRequest__handle;
}
