...
#include "rmf_traffic_msgs/msg/detail/itinerary_extend__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const rmf_traffic_msgs::msg::ItineraryExtend *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rmf_traffic_msgs::msg::ItineraryExtend *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ItineraryExtend__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rmf_traffic_msgs::msg::ItineraryExtend *>(
...
static size_t _ItineraryExtend__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ItineraryExtend(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ItineraryExtend__callbacks = {
...
static rosidl_message_type_support_t _ItineraryExtend__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ItineraryExtend__callbacks,
...
{
  return &rmf_traffic_msgs::msg::typesupport_fastrtps_cpp::_ItineraryExtend__handle;
}
