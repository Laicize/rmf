...
#include "rmf_traffic_msgs/msg/detail/heartbeat__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rmf_traffic_msgs::msg::Heartbeat & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rmf_traffic_msgs::msg::Heartbeat & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
{
  auto typed_message =
    static_cast<const rmf_traffic_msgs::msg::Heartbeat *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rmf_traffic_msgs::msg::Heartbeat *>(
    untyped_ros_message);
...
{
  return &rmf_traffic_msgs::msg::typesupport_fastrtps_cpp::_Heartbeat__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rmf_traffic_msgs, msg, Heartbeat)() {
  return &rmf_traffic_msgs::msg::typesupport_fastrtps_cpp::_Heartbeat__handle;
}
