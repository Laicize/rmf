...
#include "rmf_task_msgs/msg/detail/task_type__rosidl_typesupport_fastrtps_c.h"
...
using _TaskType__ros_msg_type = rmf_task_msgs__msg__TaskType;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TaskType__ros_msg_type * ros_message = static_cast<const _TaskType__ros_msg_type *>(untyped_ros_message);
  // Field name: type
  {
  ...
  void * untyped_ros_message)
{
  ...
  _TaskType__ros_msg_type * ros_message = static_cast<_TaskType__ros_msg_type *>(untyped_ros_message);
  // Field name: type
  {
    cdr >> ros_message->type;
  }
...
static uint32_t _TaskType__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_task_msgs__msg__TaskType(
...
static size_t _TaskType__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmf_task_msgs__msg__TaskType(
...
static message_type_support_callbacks_t __callbacks_TaskType = {
  "rmf_task_msgs::msg",
  "TaskType",
