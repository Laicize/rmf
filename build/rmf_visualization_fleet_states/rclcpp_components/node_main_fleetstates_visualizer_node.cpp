...
#define NODE_MAIN_LOGGER_NAME "fleetstates_visualizer_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libfleetstates_visualizer.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<FleetStatesVisualizer>";
