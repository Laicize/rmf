...
#include "rmf_traffic_msgs/msg/detail/negotiation_tree_node__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rmf_traffic_msgs::msg::NegotiationTreeNode & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rmf_traffic_msgs::msg::NegotiationTreeNode & ros_message)
{
  // Member: parent
  cdr >> ros_message.parent;
...
{
  auto typed_message =
    static_cast<const rmf_traffic_msgs::msg::NegotiationTreeNode *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rmf_traffic_msgs::msg::NegotiationTreeNode *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _NegotiationTreeNode__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rmf_traffic_msgs::msg::NegotiationTreeNode *>(
...
static size_t _NegotiationTreeNode__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_NegotiationTreeNode(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _NegotiationTreeNode__callbacks = {
...
static rosidl_message_type_support_t _NegotiationTreeNode__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_NegotiationTreeNode__callbacks,
...
{
  return &rmf_traffic_msgs::msg::typesupport_fastrtps_cpp::_NegotiationTreeNode__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rmf_traffic_msgs, msg, NegotiationTreeNode)() {
  return &rmf_traffic_msgs::msg::typesupport_fastrtps_cpp::_NegotiationTreeNode__handle;
}
