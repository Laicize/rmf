...
#include "rmf_traffic_msgs/srv/detail/request_changes__type_support.h"
...
static const _RequestChanges_Request_type_support_symbol_names_t _RequestChanges_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_traffic_msgs, srv, RequestChanges_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_traffic_msgs, srv, RequestChanges_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rmf_traffic_msgs, srv, RequestChanges_Request)() {
  return &::rmf_traffic_msgs::srv::rosidl_typesupport_c::RequestChanges_Request_message_type_support_handle;
}
...
static const _RequestChanges_Response_type_support_symbol_names_t _RequestChanges_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_traffic_msgs, srv, RequestChanges_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_traffic_msgs, srv, RequestChanges_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rmf_traffic_msgs, srv, RequestChanges_Response)() {
  return &::rmf_traffic_msgs::srv::rosidl_typesupport_c::RequestChanges_Response_message_type_support_handle;
}
...
static const _RequestChanges_type_support_symbol_names_t _RequestChanges_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_traffic_msgs, srv, RequestChanges)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_traffic_msgs, srv, RequestChanges)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, rmf_traffic_msgs, srv, RequestChanges)() {
  return &::rmf_traffic_msgs::srv::rosidl_typesupport_c::RequestChanges_service_type_support_handle;
}
