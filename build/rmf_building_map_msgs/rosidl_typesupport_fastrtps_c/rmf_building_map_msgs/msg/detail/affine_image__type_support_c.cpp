...
#include "rmf_building_map_msgs/msg/detail/affine_image__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // encoding, name
#include "rosidl_runtime_c/string_functions.h"  // encoding, name

// forward declare type support functions


using _AffineImage__ros_msg_type = rmf_building_map_msgs__msg__AffineImage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _AffineImage__ros_msg_type * ros_message = static_cast<const _AffineImage__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
  ...
  void * untyped_ros_message)
{
  ...
  _AffineImage__ros_msg_type * ros_message = static_cast<_AffineImage__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _AffineImage__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_building_map_msgs__msg__AffineImage(
...
static size_t _AffineImage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmf_building_map_msgs__msg__AffineImage(
...
static message_type_support_callbacks_t __callbacks_AffineImage = {
...
static rosidl_message_type_support_t _AffineImage__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_AffineImage,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_building_map_msgs, msg, AffineImage)() {
  return &_AffineImage__type_support;
}
