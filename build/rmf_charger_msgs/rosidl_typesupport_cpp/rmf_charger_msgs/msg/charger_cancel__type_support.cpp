...
static const _ChargerCancel_type_support_symbol_names_t _ChargerCancel_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rmf_charger_msgs, msg, ChargerCancel)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rmf_charger_msgs, msg, ChargerCancel)),
  }
};
...
{
  return &::rmf_charger_msgs::msg::rosidl_typesupport_cpp::ChargerCancel_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rmf_charger_msgs, msg, ChargerCancel)() {
  return get_message_type_support_handle<rmf_charger_msgs::msg::ChargerCancel>();
}
