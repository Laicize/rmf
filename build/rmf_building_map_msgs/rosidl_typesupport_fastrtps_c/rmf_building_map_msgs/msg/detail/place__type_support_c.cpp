...
#include "rmf_building_map_msgs/msg/detail/place__rosidl_typesupport_fastrtps_c.h"
...
using _Place__ros_msg_type = rmf_building_map_msgs__msg__Place;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Place__ros_msg_type * ros_message = static_cast<const _Place__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Place__ros_msg_type * ros_message = static_cast<_Place__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _Place__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_building_map_msgs__msg__Place(
...
static size_t _Place__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmf_building_map_msgs__msg__Place(
...
static message_type_support_callbacks_t __callbacks_Place = {
...
static rosidl_message_type_support_t _Place__type_support = {
