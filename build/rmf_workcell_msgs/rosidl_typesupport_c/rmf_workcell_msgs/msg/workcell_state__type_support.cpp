...
#include "rmf_workcell_msgs/msg/detail/workcell_state__type_support.h"
...
static const _WorkcellState_type_support_symbol_names_t _WorkcellState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_workcell_msgs, msg, WorkcellState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_workcell_msgs, msg, WorkcellState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rmf_workcell_msgs, msg, WorkcellState)() {
  return &::rmf_workcell_msgs::msg::rosidl_typesupport_c::WorkcellState_message_type_support_handle;
}
