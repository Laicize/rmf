...
#include "rmf_traffic_msgs/msg/detail/negotiation_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rmf_traffic_msgs::msg::NegotiationStatus & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  builtin_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.last_response_time,
    cdr);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rmf_traffic_msgs::msg::NegotiationStatus & ros_message)
{
  // Member: conflict_version
  cdr >> ros_message.conflict_version;
  ...
  size_t current_alignment)
{
  ...
  // Member: participants
  {
    ...
    size_t item_size = sizeof(ros_message.participants[0]);
...
{
  auto typed_message =
    static_cast<const rmf_traffic_msgs::msg::NegotiationStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rmf_traffic_msgs::msg::NegotiationStatus *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _NegotiationStatus__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rmf_traffic_msgs::msg::NegotiationStatus *>(
...
static size_t _NegotiationStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_NegotiationStatus(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _NegotiationStatus__callbacks = {
...
static rosidl_message_type_support_t _NegotiationStatus__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_NegotiationStatus__callbacks,
...
{
  return &rmf_traffic_msgs::msg::typesupport_fastrtps_cpp::_NegotiationStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rmf_traffic_msgs, msg, NegotiationStatus)() {
  return &rmf_traffic_msgs::msg::typesupport_fastrtps_cpp::_NegotiationStatus__handle;
}
