...
: ${AMENT_CURRENT_PREFIX:="/home/wang/rmf_ws/install/rmf_traffic_editor_test_maps"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rmf_traffic_editor_test_maps/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rmf_traffic_editor_test_maps/environment/path.sh"
