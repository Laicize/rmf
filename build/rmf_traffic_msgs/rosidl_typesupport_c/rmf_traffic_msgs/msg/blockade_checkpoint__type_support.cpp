...
#include "rmf_traffic_msgs/msg/detail/blockade_checkpoint__type_support.h"
...
static const _BlockadeCheckpoint_type_support_symbol_names_t _BlockadeCheckpoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_traffic_msgs, msg, BlockadeCheckpoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_traffic_msgs, msg, BlockadeCheckpoint)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rmf_traffic_msgs, msg, BlockadeCheckpoint)() {
  return &::rmf_traffic_msgs::msg::rosidl_typesupport_c::BlockadeCheckpoint_message_type_support_handle;
}
