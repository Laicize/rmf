...
#include "rmf_ingestor_msgs/msg/detail/ingestor_request__rosidl_typesupport_fastrtps_c.h"
...
#include "rmf_ingestor_msgs/msg/detail/ingestor_request_item__functions.h"  // items
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_rmf_ingestor_msgs
...
using _IngestorRequest__ros_msg_type = rmf_ingestor_msgs__msg__IngestorRequest;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _IngestorRequest__ros_msg_type * ros_message = static_cast<const _IngestorRequest__ros_msg_type *>(untyped_ros_message);
  // Field name: time
  {
  ...
  // Field name: items
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, rmf_ingestor_msgs, msg, IngestorRequestItem
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _IngestorRequest__ros_msg_type * ros_message = static_cast<_IngestorRequest__ros_msg_type *>(untyped_ros_message);
  // Field name: time
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: items
  {
    ...
    if (ros_message->items.data) {
      rmf_ingestor_msgs__msg__IngestorRequestItem__Sequence__fini(&ros_message->items);
    }
    if (!rmf_ingestor_msgs__msg__IngestorRequestItem__Sequence__init(&ros_message->items, size)) {
  ...
  size_t current_alignment)
{
  ...
  // field.name items
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_rmf_ingestor_msgs__msg__IngestorRequestItem(
...
static uint32_t _IngestorRequest__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_ingestor_msgs__msg__IngestorRequest(
  ...
  size_t current_alignment)
{
  ...
  // member: items
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_rmf_ingestor_msgs__msg__IngestorRequestItem(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
static size_t _IngestorRequest__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmf_ingestor_msgs__msg__IngestorRequest(
...
static message_type_support_callbacks_t __callbacks_IngestorRequest = {
...
static rosidl_message_type_support_t _IngestorRequest__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_IngestorRequest,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_ingestor_msgs, msg, IngestorRequest)() {
  return &_IngestorRequest__type_support;
}
