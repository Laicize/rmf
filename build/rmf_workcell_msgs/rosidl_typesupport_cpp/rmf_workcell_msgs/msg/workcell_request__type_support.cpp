...
static const _WorkcellRequest_type_support_symbol_names_t _WorkcellRequest_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rmf_workcell_msgs, msg, WorkcellRequest)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rmf_workcell_msgs, msg, WorkcellRequest)),
  }
};
...
{
  return &::rmf_workcell_msgs::msg::rosidl_typesupport_cpp::WorkcellRequest_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rmf_workcell_msgs, msg, WorkcellRequest)() {
  return get_message_type_support_handle<rmf_workcell_msgs::msg::WorkcellRequest>();
}
