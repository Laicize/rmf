...
#define NODE_MAIN_LOGGER_NAME "obstacle_visualizer_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libobstacle_visualizer.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ObstacleVisualizer>";
