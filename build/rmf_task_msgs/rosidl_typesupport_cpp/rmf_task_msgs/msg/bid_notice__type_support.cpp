...
static const _BidNotice_type_support_symbol_names_t _BidNotice_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rmf_task_msgs, msg, BidNotice)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rmf_task_msgs, msg, BidNotice)),
  }
};
...
{
  return &::rmf_task_msgs::msg::rosidl_typesupport_cpp::BidNotice_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rmf_task_msgs, msg, BidNotice)() {
  return get_message_type_support_handle<rmf_task_msgs::msg::BidNotice>();
}
