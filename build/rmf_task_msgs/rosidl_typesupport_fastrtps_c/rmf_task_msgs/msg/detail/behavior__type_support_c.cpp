...
#include "rmf_task_msgs/msg/detail/behavior__rosidl_typesupport_fastrtps_c.h"
...
#include "rmf_task_msgs/msg/detail/behavior_parameter__functions.h"  // parameters
...
using _Behavior__ros_msg_type = rmf_task_msgs__msg__Behavior;
  ...
  // Field name: parameters
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, rmf_task_msgs, msg, BehaviorParameter
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: parameters
  {
    ...
    if (ros_message->parameters.data) {
      rmf_task_msgs__msg__BehaviorParameter__Sequence__fini(&ros_message->parameters);
    }
    if (!rmf_task_msgs__msg__BehaviorParameter__Sequence__init(&ros_message->parameters, size)) {
  ...
  size_t current_alignment)
{
  ...
  // field.name parameters
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_rmf_task_msgs__msg__BehaviorParameter(
...
static uint32_t _Behavior__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_task_msgs__msg__Behavior(
  ...
  size_t current_alignment)
{
  ...
  // member: parameters
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_rmf_task_msgs__msg__BehaviorParameter(
...
static size_t _Behavior__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmf_task_msgs__msg__Behavior(
