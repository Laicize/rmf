...
#include "rmf_task_msgs/msg/detail/delivery__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const rmf_task_msgs::msg::Behavior &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  size_t current_alignment)
{
  ...
  // Member: pickup_behavior
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        rmf_task_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Behavior(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
{
  auto typed_message =
    static_cast<const rmf_task_msgs::msg::Delivery *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rmf_task_msgs::msg::Delivery *>(
    untyped_ros_message);
...
static size_t _Delivery__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Delivery(full_bounded, is_plain, 0);
...
{
  return &rmf_task_msgs::msg::typesupport_fastrtps_cpp::_Delivery__handle;
}
