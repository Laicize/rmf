...
#include "rmf_scheduler_msgs/srv/detail/create_trigger__type_support.h"
...
static const _CreateTrigger_Request_type_support_symbol_names_t _CreateTrigger_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_scheduler_msgs, srv, CreateTrigger_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_scheduler_msgs, srv, CreateTrigger_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rmf_scheduler_msgs, srv, CreateTrigger_Request)() {
  return &::rmf_scheduler_msgs::srv::rosidl_typesupport_c::CreateTrigger_Request_message_type_support_handle;
}
...
static const _CreateTrigger_Response_type_support_symbol_names_t _CreateTrigger_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_scheduler_msgs, srv, CreateTrigger_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_scheduler_msgs, srv, CreateTrigger_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rmf_scheduler_msgs, srv, CreateTrigger_Response)() {
  return &::rmf_scheduler_msgs::srv::rosidl_typesupport_c::CreateTrigger_Response_message_type_support_handle;
}
...
static const _CreateTrigger_type_support_symbol_names_t _CreateTrigger_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_scheduler_msgs, srv, CreateTrigger)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_scheduler_msgs, srv, CreateTrigger)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, rmf_scheduler_msgs, srv, CreateTrigger)() {
  return &::rmf_scheduler_msgs::srv::rosidl_typesupport_c::CreateTrigger_service_type_support_handle;
}
