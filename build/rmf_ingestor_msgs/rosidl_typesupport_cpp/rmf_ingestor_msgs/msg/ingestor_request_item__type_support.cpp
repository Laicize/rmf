...
static const _IngestorRequestItem_type_support_symbol_names_t _IngestorRequestItem_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rmf_ingestor_msgs, msg, IngestorRequestItem)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rmf_ingestor_msgs, msg, IngestorRequestItem)),
  }
};
...
{
  return &::rmf_ingestor_msgs::msg::rosidl_typesupport_cpp::IngestorRequestItem_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rmf_ingestor_msgs, msg, IngestorRequestItem)() {
  return get_message_type_support_handle<rmf_ingestor_msgs::msg::IngestorRequestItem>();
}
