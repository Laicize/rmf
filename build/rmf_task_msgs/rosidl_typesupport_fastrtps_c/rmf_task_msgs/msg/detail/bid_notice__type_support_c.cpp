...
#include "rmf_task_msgs/msg/detail/bid_notice__rosidl_typesupport_fastrtps_c.h"
...
#include "builtin_interfaces/msg/detail/duration__functions.h"  // time_window
#include "rosidl_runtime_c/string.h"  // request, task_id
#include "rosidl_runtime_c/string_functions.h"  // request, task_id
...
using _BidNotice__ros_msg_type = rmf_task_msgs__msg__BidNotice;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _BidNotice__ros_msg_type * ros_message = static_cast<const _BidNotice__ros_msg_type *>(untyped_ros_message);
  // Field name: request
  {
  ...
  void * untyped_ros_message)
{
  ...
  _BidNotice__ros_msg_type * ros_message = static_cast<_BidNotice__ros_msg_type *>(untyped_ros_message);
  // Field name: request
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _BidNotice__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_task_msgs__msg__BidNotice(
...
static size_t _BidNotice__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmf_task_msgs__msg__BidNotice(
...
static message_type_support_callbacks_t __callbacks_BidNotice = {
  "rmf_task_msgs::msg",
  "BidNotice",
