...
#include "rmf_traffic_msgs/msg/detail/schedule_query_participants__rosidl_typesupport_fastrtps_c.h"
...
using _ScheduleQueryParticipants__ros_msg_type = rmf_traffic_msgs__msg__ScheduleQueryParticipants;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ScheduleQueryParticipants__ros_msg_type * ros_message = static_cast<const _ScheduleQueryParticipants__ros_msg_type *>(untyped_ros_message);
  // Field name: type
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ScheduleQueryParticipants__ros_msg_type * ros_message = static_cast<_ScheduleQueryParticipants__ros_msg_type *>(untyped_ros_message);
  // Field name: type
  {
    cdr >> ros_message->type;
  }
...
static uint32_t _ScheduleQueryParticipants__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_traffic_msgs__msg__ScheduleQueryParticipants(
...
static size_t _ScheduleQueryParticipants__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmf_traffic_msgs__msg__ScheduleQueryParticipants(
...
static message_type_support_callbacks_t __callbacks_ScheduleQueryParticipants = {
...
static rosidl_message_type_support_t _ScheduleQueryParticipants__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ScheduleQueryParticipants,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_traffic_msgs, msg, ScheduleQueryParticipants)() {
  return &_ScheduleQueryParticipants__type_support;
}
