...
#define NODE_MAIN_LOGGER_NAME "floorplan_visualizer_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libfloorplan_visualizer.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<FloorplanVisualizer>";
