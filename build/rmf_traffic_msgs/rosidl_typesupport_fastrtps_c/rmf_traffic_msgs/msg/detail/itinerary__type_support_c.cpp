...
#include "rmf_traffic_msgs/msg/detail/itinerary__rosidl_typesupport_fastrtps_c.h"
...
using _Itinerary__ros_msg_type = rmf_traffic_msgs__msg__Itinerary;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Itinerary__ros_msg_type * ros_message = static_cast<const _Itinerary__ros_msg_type *>(untyped_ros_message);
  // Field name: routes
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Itinerary__ros_msg_type * ros_message = static_cast<_Itinerary__ros_msg_type *>(untyped_ros_message);
  // Field name: routes
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _Itinerary__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_traffic_msgs__msg__Itinerary(
...
static size_t _Itinerary__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmf_traffic_msgs__msg__Itinerary(
...
static message_type_support_callbacks_t __callbacks_Itinerary = {
