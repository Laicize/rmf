...
#include "rmf_workcell_msgs/msg/detail/workcell_state__rosidl_typesupport_fastrtps_c.h"
...
using _WorkcellState__ros_msg_type = rmf_workcell_msgs__msg__WorkcellState;

static bool _WorkcellState__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _WorkcellState__ros_msg_type * ros_message = static_cast<const _WorkcellState__ros_msg_type *>(untyped_ros_message);
  // Field name: time
  {
...
static bool _WorkcellState__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _WorkcellState__ros_msg_type * ros_message = static_cast<_WorkcellState__ros_msg_type *>(untyped_ros_message);
  // Field name: time
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _WorkcellState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_workcell_msgs__msg__WorkcellState(
...
static size_t _WorkcellState__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_rmf_workcell_msgs__msg__WorkcellState(
...
static message_type_support_callbacks_t __callbacks_WorkcellState = {
  "rmf_workcell_msgs::msg",
  "WorkcellState",
  _WorkcellState__cdr_serialize,
  _WorkcellState__cdr_deserialize,
  _WorkcellState__get_serialized_size,
  _WorkcellState__max_serialized_size
};

static rosidl_message_type_support_t _WorkcellState__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_WorkcellState,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_workcell_msgs, msg, WorkcellState)() {
  return &_WorkcellState__type_support;
}
