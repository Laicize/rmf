...
#include "rmf_traffic_msgs/msg/detail/trajectory__rosidl_typesupport_fastrtps_c.h"
...
#include "rmf_traffic_msgs/msg/detail/trajectory_waypoint__functions.h"  // waypoints
...
using _Trajectory__ros_msg_type = rmf_traffic_msgs__msg__Trajectory;
  ...
  // Field name: waypoints
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, rmf_traffic_msgs, msg, TrajectoryWaypoint
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: waypoints
  {
    ...
    if (ros_message->waypoints.data) {
      rmf_traffic_msgs__msg__TrajectoryWaypoint__Sequence__fini(&ros_message->waypoints);
    }
    if (!rmf_traffic_msgs__msg__TrajectoryWaypoint__Sequence__init(&ros_message->waypoints, size)) {
  ...
  size_t current_alignment)
{
  ...
  // field.name waypoints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_rmf_traffic_msgs__msg__TrajectoryWaypoint(
...
static uint32_t _Trajectory__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_traffic_msgs__msg__Trajectory(
  ...
  size_t current_alignment)
{
  ...
  // member: waypoints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_rmf_traffic_msgs__msg__TrajectoryWaypoint(
...
static size_t _Trajectory__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmf_traffic_msgs__msg__Trajectory(
