...
#include "rmf_traffic_msgs/srv/detail/register_query__type_support.h"
...
static const _RegisterQuery_Request_type_support_symbol_names_t _RegisterQuery_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_traffic_msgs, srv, RegisterQuery_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_traffic_msgs, srv, RegisterQuery_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rmf_traffic_msgs, srv, RegisterQuery_Request)() {
  return &::rmf_traffic_msgs::srv::rosidl_typesupport_c::RegisterQuery_Request_message_type_support_handle;
}
...
static const _RegisterQuery_Response_type_support_symbol_names_t _RegisterQuery_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_traffic_msgs, srv, RegisterQuery_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_traffic_msgs, srv, RegisterQuery_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rmf_traffic_msgs, srv, RegisterQuery_Response)() {
  return &::rmf_traffic_msgs::srv::rosidl_typesupport_c::RegisterQuery_Response_message_type_support_handle;
}
...
static const _RegisterQuery_type_support_symbol_names_t _RegisterQuery_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_traffic_msgs, srv, RegisterQuery)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_traffic_msgs, srv, RegisterQuery)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, rmf_traffic_msgs, srv, RegisterQuery)() {
  return &::rmf_traffic_msgs::srv::rosidl_typesupport_c::RegisterQuery_service_type_support_handle;
}
