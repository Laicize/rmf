...
#include "rmf_scheduler_msgs/msg/detail/trigger__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // group, name
#include "rosidl_runtime_c/string_functions.h"  // group, name
...
using _Trigger__ros_msg_type = rmf_scheduler_msgs__msg__Trigger;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Trigger__ros_msg_type * ros_message = static_cast<const _Trigger__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Trigger__ros_msg_type * ros_message = static_cast<_Trigger__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _Trigger__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_scheduler_msgs__msg__Trigger(
...
static size_t _Trigger__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmf_scheduler_msgs__msg__Trigger(
...
static message_type_support_callbacks_t __callbacks_Trigger = {
...
static rosidl_message_type_support_t _Trigger__type_support = {
