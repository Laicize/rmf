...
static const _LiftClearance_Request_type_support_symbol_names_t _LiftClearance_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_fleet_msgs, srv, LiftClearance_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_fleet_msgs, srv, LiftClearance_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rmf_fleet_msgs, srv, LiftClearance_Request)() {
  return &::rmf_fleet_msgs::srv::rosidl_typesupport_c::LiftClearance_Request_message_type_support_handle;
}
...
static const _LiftClearance_Response_type_support_symbol_names_t _LiftClearance_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_fleet_msgs, srv, LiftClearance_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_fleet_msgs, srv, LiftClearance_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rmf_fleet_msgs, srv, LiftClearance_Response)() {
  return &::rmf_fleet_msgs::srv::rosidl_typesupport_c::LiftClearance_Response_message_type_support_handle;
}
...
static const _LiftClearance_type_support_symbol_names_t _LiftClearance_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_fleet_msgs, srv, LiftClearance)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_fleet_msgs, srv, LiftClearance)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, rmf_fleet_msgs, srv, LiftClearance)() {
  return &::rmf_fleet_msgs::srv::rosidl_typesupport_c::LiftClearance_service_type_support_handle;
}
