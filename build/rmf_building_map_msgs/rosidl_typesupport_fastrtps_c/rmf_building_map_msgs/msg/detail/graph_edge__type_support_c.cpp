...
#include "rmf_building_map_msgs/msg/detail/graph_edge__rosidl_typesupport_fastrtps_c.h"
...
using _GraphEdge__ros_msg_type = rmf_building_map_msgs__msg__GraphEdge;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: v1_idx
  {
    cdr << ros_message->v1_idx;
  }

  // Field name: v2_idx
  {
    cdr << ros_message->v2_idx;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name v1_idx
  {
    size_t item_size = sizeof(ros_message->v1_idx);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name v2_idx
  {
    size_t item_size = sizeof(ros_message->v2_idx);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name params
...
static uint32_t _GraphEdge__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_building_map_msgs__msg__GraphEdge(
...
static size_t _GraphEdge__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmf_building_map_msgs__msg__GraphEdge(
