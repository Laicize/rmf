...
#include "rmf_traffic_msgs/msg/detail/schedule_change_cull__rosidl_typesupport_fastrtps_c.h"
...
using _ScheduleChangeCull__ros_msg_type = rmf_traffic_msgs__msg__ScheduleChangeCull;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ScheduleChangeCull__ros_msg_type * ros_message = static_cast<const _ScheduleChangeCull__ros_msg_type *>(untyped_ros_message);
  // Field name: time
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ScheduleChangeCull__ros_msg_type * ros_message = static_cast<_ScheduleChangeCull__ros_msg_type *>(untyped_ros_message);
  // Field name: time
  {
    cdr >> ros_message->time;
  }
...
static uint32_t _ScheduleChangeCull__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_traffic_msgs__msg__ScheduleChangeCull(
...
static size_t _ScheduleChangeCull__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmf_traffic_msgs__msg__ScheduleChangeCull(
...
static message_type_support_callbacks_t __callbacks_ScheduleChangeCull = {
...
static rosidl_message_type_support_t _ScheduleChangeCull__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ScheduleChangeCull,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_traffic_msgs, msg, ScheduleChangeCull)() {
  return &_ScheduleChangeCull__type_support;
}
