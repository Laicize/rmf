...
#include "rmf_building_map_msgs/msg/detail/graph_node__rosidl_typesupport_fastrtps_c.h"
...
using _GraphNode__ros_msg_type = rmf_building_map_msgs__msg__GraphNode;
  ...
  void * untyped_ros_message)
{
  ...
  _GraphNode__ros_msg_type * ros_message = static_cast<_GraphNode__ros_msg_type *>(untyped_ros_message);
  // Field name: x
  {
    cdr >> ros_message->x;
  }
...
static uint32_t _GraphNode__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_building_map_msgs__msg__GraphNode(
...
static size_t _GraphNode__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmf_building_map_msgs__msg__GraphNode(
