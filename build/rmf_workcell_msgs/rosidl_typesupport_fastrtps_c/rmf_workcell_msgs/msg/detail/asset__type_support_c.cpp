...
#include "rmf_workcell_msgs/msg/detail/asset__rosidl_typesupport_fastrtps_c.h"
...
using _Asset__ros_msg_type = rmf_workcell_msgs__msg__Asset;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Asset__ros_msg_type * ros_message = static_cast<const _Asset__ros_msg_type *>(untyped_ros_message);
  // Field name: guid
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Asset__ros_msg_type * ros_message = static_cast<_Asset__ros_msg_type *>(untyped_ros_message);
  // Field name: guid
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _Asset__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_workcell_msgs__msg__Asset(
...
static size_t _Asset__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmf_workcell_msgs__msg__Asset(
...
static message_type_support_callbacks_t __callbacks_Asset = {
...
static rosidl_message_type_support_t _Asset__type_support = {
