...
#include "rmf_obstacle_msgs/msg/detail/obstacle__type_support.h"
...
static const _Obstacle_type_support_symbol_names_t _Obstacle_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_obstacle_msgs, msg, Obstacle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_obstacle_msgs, msg, Obstacle)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rmf_obstacle_msgs, msg, Obstacle)() {
  return &::rmf_obstacle_msgs::msg::rosidl_typesupport_c::Obstacle_message_type_support_handle;
}
