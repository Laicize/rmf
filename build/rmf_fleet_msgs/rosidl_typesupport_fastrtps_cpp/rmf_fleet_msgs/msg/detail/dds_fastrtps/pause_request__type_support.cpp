...
#include "rmf_fleet_msgs/msg/detail/pause_request__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const rmf_fleet_msgs::msg::PauseRequest *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rmf_fleet_msgs::msg::PauseRequest *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PauseRequest__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rmf_fleet_msgs::msg::PauseRequest *>(
...
static size_t _PauseRequest__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PauseRequest(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PauseRequest__callbacks = {
  "rmf_fleet_msgs::msg",
  "PauseRequest",
...
static rosidl_message_type_support_t _PauseRequest__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PauseRequest__callbacks,
...
{
  return &rmf_fleet_msgs::msg::typesupport_fastrtps_cpp::_PauseRequest__handle;
}
