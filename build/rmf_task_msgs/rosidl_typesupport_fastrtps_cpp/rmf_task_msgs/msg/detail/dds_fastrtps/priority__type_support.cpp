...
#include "rmf_task_msgs/msg/detail/priority__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const rmf_task_msgs::msg::Priority *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rmf_task_msgs::msg::Priority *>(
    untyped_ros_message);
...
static size_t _Priority__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Priority(full_bounded, is_plain, 0);
...
{
  return &rmf_task_msgs::msg::typesupport_fastrtps_cpp::_Priority__handle;
}
