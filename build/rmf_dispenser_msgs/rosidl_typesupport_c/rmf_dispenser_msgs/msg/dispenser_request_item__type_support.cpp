...
#include "rmf_dispenser_msgs/msg/detail/dispenser_request_item__type_support.h"
...
static const _DispenserRequestItem_type_support_symbol_names_t _DispenserRequestItem_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_dispenser_msgs, msg, DispenserRequestItem)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_dispenser_msgs, msg, DispenserRequestItem)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rmf_dispenser_msgs, msg, DispenserRequestItem)() {
  return &::rmf_dispenser_msgs::msg::rosidl_typesupport_c::DispenserRequestItem_message_type_support_handle;
}
