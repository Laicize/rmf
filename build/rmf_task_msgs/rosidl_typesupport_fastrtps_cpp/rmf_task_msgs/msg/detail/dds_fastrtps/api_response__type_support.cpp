...
#include "rmf_task_msgs/msg/detail/api_response__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const rmf_task_msgs::msg::ApiResponse *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rmf_task_msgs::msg::ApiResponse *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ApiResponse__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rmf_task_msgs::msg::ApiResponse *>(
...
static size_t _ApiResponse__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ApiResponse(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ApiResponse__callbacks = {
  "rmf_task_msgs::msg",
  "ApiResponse",
...
static rosidl_message_type_support_t _ApiResponse__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ApiResponse__callbacks,
...
{
  return &rmf_task_msgs::msg::typesupport_fastrtps_cpp::_ApiResponse__handle;
}
