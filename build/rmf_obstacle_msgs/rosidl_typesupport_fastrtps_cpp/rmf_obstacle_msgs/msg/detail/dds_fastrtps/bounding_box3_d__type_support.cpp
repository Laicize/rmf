...
#include "rmf_obstacle_msgs/msg/detail/bounding_box3_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rmf_obstacle_msgs::msg::BoundingBox3D & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rmf_obstacle_msgs::msg::BoundingBox3D & ros_message)
{
  // Member: center
...
{
  auto typed_message =
    static_cast<const rmf_obstacle_msgs::msg::BoundingBox3D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rmf_obstacle_msgs::msg::BoundingBox3D *>(
    untyped_ros_message);
...
{
  return &rmf_obstacle_msgs::msg::typesupport_fastrtps_cpp::_BoundingBox3D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rmf_obstacle_msgs, msg, BoundingBox3D)() {
  return &rmf_obstacle_msgs::msg::typesupport_fastrtps_cpp::_BoundingBox3D__handle;
}
