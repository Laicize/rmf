...
#include "rmf_traffic_msgs/msg/detail/blockade_heartbeat__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const rmf_traffic_msgs::msg::BlockadeStatus &,
  ...
  // Member: statuses
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.statuses[index], current_alignment);
    }
  }
  // Member: has_gridlock
  {
  ...
  size_t current_alignment)
{
  ...
  // Member: statuses
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        rmf_traffic_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_BlockadeStatus(
...
{
  auto typed_message =
    static_cast<const rmf_traffic_msgs::msg::BlockadeHeartbeat *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rmf_traffic_msgs::msg::BlockadeHeartbeat *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BlockadeHeartbeat__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rmf_traffic_msgs::msg::BlockadeHeartbeat *>(
...
static size_t _BlockadeHeartbeat__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_BlockadeHeartbeat(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _BlockadeHeartbeat__callbacks = {
...
static rosidl_message_type_support_t _BlockadeHeartbeat__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_BlockadeHeartbeat__callbacks,
...
{
  return &rmf_traffic_msgs::msg::typesupport_fastrtps_cpp::_BlockadeHeartbeat__handle;
}
