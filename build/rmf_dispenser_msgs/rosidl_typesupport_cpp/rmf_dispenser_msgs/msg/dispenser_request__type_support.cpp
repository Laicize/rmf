...
static const _DispenserRequest_type_support_symbol_names_t _DispenserRequest_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rmf_dispenser_msgs, msg, DispenserRequest)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rmf_dispenser_msgs, msg, DispenserRequest)),
  }
};
...
{
  return &::rmf_dispenser_msgs::msg::rosidl_typesupport_cpp::DispenserRequest_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rmf_dispenser_msgs, msg, DispenserRequest)() {
  return get_message_type_support_handle<rmf_dispenser_msgs::msg::DispenserRequest>();
}
