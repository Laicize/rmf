...
#include "rmf_traffic_msgs/msg/detail/itinerary_clear__type_support.h"
...
static const _ItineraryClear_type_support_symbol_names_t _ItineraryClear_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_traffic_msgs, msg, ItineraryClear)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_traffic_msgs, msg, ItineraryClear)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rmf_traffic_msgs, msg, ItineraryClear)() {
  return &::rmf_traffic_msgs::msg::rosidl_typesupport_c::ItineraryClear_message_type_support_handle;
}
