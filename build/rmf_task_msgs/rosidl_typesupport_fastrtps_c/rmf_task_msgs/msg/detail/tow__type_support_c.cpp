...
#include "rmf_task_msgs/msg/detail/tow__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // dropoff_place_name, object_id, object_type, pickup_place_name, task_id
#include "rosidl_runtime_c/string_functions.h"  // dropoff_place_name, object_id, object_type, pickup_place_name, task_id

// forward declare type support functions


using _Tow__ros_msg_type = rmf_task_msgs__msg__Tow;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Tow__ros_msg_type * ros_message = static_cast<const _Tow__ros_msg_type *>(untyped_ros_message);
  // Field name: task_id
  {
  ...
  // Field name: is_dropoff_place_known
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Tow__ros_msg_type * ros_message = static_cast<_Tow__ros_msg_type *>(untyped_ros_message);
  // Field name: task_id
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _Tow__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_task_msgs__msg__Tow(
...
static size_t _Tow__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmf_task_msgs__msg__Tow(
...
static message_type_support_callbacks_t __callbacks_Tow = {
  "rmf_task_msgs::msg",
  "Tow",
  _Tow__cdr_serialize,
...
static rosidl_message_type_support_t _Tow__type_support = {
