...
#include "rmf_scheduler_msgs/msg/detail/payload__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // message_type, topic
#include "rosidl_runtime_c/string_functions.h"  // message_type, topic

// forward declare type support functions


using _Payload__ros_msg_type = rmf_scheduler_msgs__msg__Payload;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Payload__ros_msg_type * ros_message = static_cast<const _Payload__ros_msg_type *>(untyped_ros_message);
  // Field name: type
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Payload__ros_msg_type * ros_message = static_cast<_Payload__ros_msg_type *>(untyped_ros_message);
  // Field name: type
  {
    cdr >> ros_message->type;
  }
...
static uint32_t _Payload__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_scheduler_msgs__msg__Payload(
...
static size_t _Payload__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmf_scheduler_msgs__msg__Payload(
...
static message_type_support_callbacks_t __callbacks_Payload = {
...
static rosidl_message_type_support_t _Payload__type_support = {
