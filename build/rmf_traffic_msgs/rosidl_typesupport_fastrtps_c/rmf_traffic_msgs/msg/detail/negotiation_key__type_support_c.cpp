...
#include "rmf_traffic_msgs/msg/detail/negotiation_key__rosidl_typesupport_fastrtps_c.h"
...
using _NegotiationKey__ros_msg_type = rmf_traffic_msgs__msg__NegotiationKey;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _NegotiationKey__ros_msg_type * ros_message = static_cast<const _NegotiationKey__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _NegotiationKey__ros_msg_type * ros_message = static_cast<_NegotiationKey__ros_msg_type *>(untyped_ros_message);
  // Field name: participant
  {
    cdr >> ros_message->participant;
  }
...
static uint32_t _NegotiationKey__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_traffic_msgs__msg__NegotiationKey(
...
static size_t _NegotiationKey__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmf_traffic_msgs__msg__NegotiationKey(
...
static message_type_support_callbacks_t __callbacks_NegotiationKey = {
...
static rosidl_message_type_support_t _NegotiationKey__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_NegotiationKey,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_traffic_msgs, msg, NegotiationKey)() {
  return &_NegotiationKey__type_support;
}
