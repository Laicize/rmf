...
#include "rmf_fleet_msgs/msg/detail/location__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // level_name
#include "rosidl_runtime_c/string_functions.h"  // level_name

// forward declare type support functions
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_rmf_fleet_msgs
...
using _Location__ros_msg_type = rmf_fleet_msgs__msg__Location;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: obey_approach_speed_limit
  {
    cdr << (ros_message->obey_approach_speed_limit ? true : false);
  }

  // Field name: approach_speed_limit
  {
...
static uint32_t _Location__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_fleet_msgs__msg__Location(
...
static size_t _Location__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmf_fleet_msgs__msg__Location(
