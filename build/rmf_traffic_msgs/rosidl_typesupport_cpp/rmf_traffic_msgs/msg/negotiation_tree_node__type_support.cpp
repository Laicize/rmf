...
static const _NegotiationTreeNode_type_support_symbol_names_t _NegotiationTreeNode_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rmf_traffic_msgs, msg, NegotiationTreeNode)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rmf_traffic_msgs, msg, NegotiationTreeNode)),
  }
};
...
{
  return &::rmf_traffic_msgs::msg::rosidl_typesupport_cpp::NegotiationTreeNode_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rmf_traffic_msgs, msg, NegotiationTreeNode)() {
  return get_message_type_support_handle<rmf_traffic_msgs::msg::NegotiationTreeNode>();
}
