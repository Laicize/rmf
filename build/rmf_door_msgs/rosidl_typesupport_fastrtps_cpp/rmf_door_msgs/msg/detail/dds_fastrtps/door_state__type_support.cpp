...
#include "rmf_door_msgs/msg/detail/door_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const rmf_door_msgs::msg::DoorState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rmf_door_msgs::msg::DoorState *>(
    untyped_ros_message);
...
{
  return &rmf_door_msgs::msg::typesupport_fastrtps_cpp::_DoorState__handle;
}
