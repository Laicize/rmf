...
#include "rmf_obstacle_msgs/msg/detail/obstacles__type_support.h"
...
static const _Obstacles_type_support_symbol_names_t _Obstacles_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_obstacle_msgs, msg, Obstacles)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_obstacle_msgs, msg, Obstacles)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rmf_obstacle_msgs, msg, Obstacles)() {
  return &::rmf_obstacle_msgs::msg::rosidl_typesupport_c::Obstacles_message_type_support_handle;
}
