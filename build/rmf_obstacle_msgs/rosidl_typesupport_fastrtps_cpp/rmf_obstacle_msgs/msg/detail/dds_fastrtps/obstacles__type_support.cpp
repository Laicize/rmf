...
#include "rmf_obstacle_msgs/msg/detail/obstacles__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const rmf_obstacle_msgs::msg::Obstacle &,
...
cdr_serialize(
  const rmf_obstacle_msgs::msg::Obstacles & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rmf_obstacle_msgs::msg::Obstacles & ros_message)
{
  // Member: obstacles
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: obstacles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        rmf_obstacle_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Obstacle(
...
{
  auto typed_message =
    static_cast<const rmf_obstacle_msgs::msg::Obstacles *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rmf_obstacle_msgs::msg::Obstacles *>(
    untyped_ros_message);
...
{
  return &rmf_obstacle_msgs::msg::typesupport_fastrtps_cpp::_Obstacles__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rmf_obstacle_msgs, msg, Obstacles)() {
  return &rmf_obstacle_msgs::msg::typesupport_fastrtps_cpp::_Obstacles__handle;
}
