...
#include "rmf_visualization_msgs/msg/detail/rviz_param__rosidl_typesupport_fastrtps_c.h"
...
using _RvizParam__ros_msg_type = rmf_visualization_msgs__msg__RvizParam;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _RvizParam__ros_msg_type * ros_message = static_cast<const _RvizParam__ros_msg_type *>(untyped_ros_message);
  // Field name: map_name
  {
  ...
  void * untyped_ros_message)
{
  ...
  _RvizParam__ros_msg_type * ros_message = static_cast<_RvizParam__ros_msg_type *>(untyped_ros_message);
  // Field name: map_name
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _RvizParam__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_visualization_msgs__msg__RvizParam(
...
static size_t _RvizParam__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmf_visualization_msgs__msg__RvizParam(
...
static message_type_support_callbacks_t __callbacks_RvizParam = {
...
static rosidl_message_type_support_t _RvizParam__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_RvizParam,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_visualization_msgs, msg, RvizParam)() {
  return &_RvizParam__type_support;
}
