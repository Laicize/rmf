...
#include "rmf_traffic_msgs/msg/detail/trajectory_waypoint__rosidl_typesupport_fastrtps_c.h"
...
using _TrajectoryWaypoint__ros_msg_type = rmf_traffic_msgs__msg__TrajectoryWaypoint;
...
static uint32_t _TrajectoryWaypoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_traffic_msgs__msg__TrajectoryWaypoint(
...
static size_t _TrajectoryWaypoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmf_traffic_msgs__msg__TrajectoryWaypoint(
