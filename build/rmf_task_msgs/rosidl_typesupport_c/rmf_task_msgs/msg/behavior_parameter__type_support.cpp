...
#include "rmf_task_msgs/msg/detail/behavior_parameter__type_support.h"
...
static const _BehaviorParameter_type_support_symbol_names_t _BehaviorParameter_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_task_msgs, msg, BehaviorParameter)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmf_task_msgs, msg, BehaviorParameter)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rmf_task_msgs, msg, BehaviorParameter)() {
  return &::rmf_task_msgs::msg::rosidl_typesupport_c::BehaviorParameter_message_type_support_handle;
}
