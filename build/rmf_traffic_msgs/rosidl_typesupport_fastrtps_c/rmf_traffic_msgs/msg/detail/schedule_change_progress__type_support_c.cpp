...
#include "rmf_traffic_msgs/msg/detail/schedule_change_progress__rosidl_typesupport_fastrtps_c.h"
...
using _ScheduleChangeProgress__ros_msg_type = rmf_traffic_msgs__msg__ScheduleChangeProgress;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ScheduleChangeProgress__ros_msg_type * ros_message = static_cast<const _ScheduleChangeProgress__ros_msg_type *>(untyped_ros_message);
  // Field name: has_progress
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ScheduleChangeProgress__ros_msg_type * ros_message = static_cast<_ScheduleChangeProgress__ros_msg_type *>(untyped_ros_message);
  // Field name: has_progress
  {
    uint8_t tmp;
    cdr >> tmp;
...
static uint32_t _ScheduleChangeProgress__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_traffic_msgs__msg__ScheduleChangeProgress(
...
static size_t _ScheduleChangeProgress__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmf_traffic_msgs__msg__ScheduleChangeProgress(
...
static message_type_support_callbacks_t __callbacks_ScheduleChangeProgress = {
...
static rosidl_message_type_support_t _ScheduleChangeProgress__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ScheduleChangeProgress,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_traffic_msgs, msg, ScheduleChangeProgress)() {
  return &_ScheduleChangeProgress__type_support;
}
