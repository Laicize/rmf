...
static const _DoorSessions_type_support_symbol_names_t _DoorSessions_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rmf_door_msgs, msg, DoorSessions)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rmf_door_msgs, msg, DoorSessions)),
  }
};
...
{
  return &::rmf_door_msgs::msg::rosidl_typesupport_cpp::DoorSessions_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rmf_door_msgs, msg, DoorSessions)() {
  return get_message_type_support_handle<rmf_door_msgs::msg::DoorSessions>();
}
