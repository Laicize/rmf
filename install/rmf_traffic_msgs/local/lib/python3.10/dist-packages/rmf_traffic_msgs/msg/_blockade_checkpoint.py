...
class Metaclass_BlockadeCheckpoint(type):
    """Metaclass of message 'BlockadeCheckpoint'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__blockade_checkpoint
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__blockade_checkpoint
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__blockade_checkpoint
            cls._TYPE_SUPPORT = module.type_support_msg__msg__blockade_checkpoint
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__blockade_checkpoint
...
class BlockadeCheckpoint(metaclass=Metaclass_BlockadeCheckpoint):
    """Message class 'BlockadeCheckpoint'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.can_hold = kwargs.get('can_hold', bool())
    ...
    def __eq__(self, other):
        ...
        if self.map_name != other.map_name:
            return False
        if self.can_hold != other.can_hold:
            return False
        return True
    ...
    def can_hold(self, value):
        if __debug__:
            assert \
                ...
                "The 'can_hold' field must be of type 'bool'"
        self._can_hold = value
