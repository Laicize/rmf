...
#include "rmf_traffic_msgs/msg/detail/shape__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const rmf_traffic_msgs::msg::Shape *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rmf_traffic_msgs::msg::Shape *>(
    untyped_ros_message);
...
{
  return &rmf_traffic_msgs::msg::typesupport_fastrtps_cpp::_Shape__handle;
}
