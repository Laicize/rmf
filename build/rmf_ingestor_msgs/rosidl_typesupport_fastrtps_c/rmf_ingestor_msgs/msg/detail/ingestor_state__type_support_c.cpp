...
#include "rmf_ingestor_msgs/msg/detail/ingestor_state__rosidl_typesupport_fastrtps_c.h"
...
using _IngestorState__ros_msg_type = rmf_ingestor_msgs__msg__IngestorState;

static bool _IngestorState__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _IngestorState__ros_msg_type * ros_message = static_cast<const _IngestorState__ros_msg_type *>(untyped_ros_message);
  // Field name: time
  {
...
static bool _IngestorState__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _IngestorState__ros_msg_type * ros_message = static_cast<_IngestorState__ros_msg_type *>(untyped_ros_message);
  // Field name: time
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _IngestorState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_ingestor_msgs__msg__IngestorState(
...
static size_t _IngestorState__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_rmf_ingestor_msgs__msg__IngestorState(
...
static message_type_support_callbacks_t __callbacks_IngestorState = {
  "rmf_ingestor_msgs::msg",
  "IngestorState",
  _IngestorState__cdr_serialize,
  _IngestorState__cdr_deserialize,
  _IngestorState__get_serialized_size,
  _IngestorState__max_serialized_size
};

static rosidl_message_type_support_t _IngestorState__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_IngestorState,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_ingestor_msgs, msg, IngestorState)() {
  return &_IngestorState__type_support;
}
