...
#include "rmf_task_msgs/msg/detail/api_request__rosidl_typesupport_fastrtps_c.h"
...
using _ApiRequest__ros_msg_type = rmf_task_msgs__msg__ApiRequest;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ApiRequest__ros_msg_type * ros_message = static_cast<const _ApiRequest__ros_msg_type *>(untyped_ros_message);
  // Field name: json_msg
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ApiRequest__ros_msg_type * ros_message = static_cast<_ApiRequest__ros_msg_type *>(untyped_ros_message);
  // Field name: json_msg
  {
    std::string tmp;
    cdr >> tmp;
...
size_t get_serialized_size_rmf_task_msgs__msg__ApiRequest(
  const void * untyped_ros_message,
...
static uint32_t _ApiRequest__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_task_msgs__msg__ApiRequest(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rmf_task_msgs
size_t max_serialized_size_rmf_task_msgs__msg__ApiRequest(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _ApiRequest__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmf_task_msgs__msg__ApiRequest(
...
static message_type_support_callbacks_t __callbacks_ApiRequest = {
  "rmf_task_msgs::msg",
  "ApiRequest",
...
static rosidl_message_type_support_t _ApiRequest__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ApiRequest,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_task_msgs, msg, ApiRequest)() {
  return &_ApiRequest__type_support;
}
