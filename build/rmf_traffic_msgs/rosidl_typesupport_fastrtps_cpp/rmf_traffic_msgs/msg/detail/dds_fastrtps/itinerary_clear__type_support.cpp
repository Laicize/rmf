...
#include "rmf_traffic_msgs/msg/detail/itinerary_clear__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const rmf_traffic_msgs::msg::ItineraryClear *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rmf_traffic_msgs::msg::ItineraryClear *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ItineraryClear__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rmf_traffic_msgs::msg::ItineraryClear *>(
...
static size_t _ItineraryClear__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ItineraryClear(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ItineraryClear__callbacks = {
...
static rosidl_message_type_support_t _ItineraryClear__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ItineraryClear__callbacks,
...
{
  return &rmf_traffic_msgs::msg::typesupport_fastrtps_cpp::_ItineraryClear__handle;
}
