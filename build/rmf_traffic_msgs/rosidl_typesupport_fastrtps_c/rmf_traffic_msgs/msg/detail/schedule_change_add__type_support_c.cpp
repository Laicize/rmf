...
#include "rmf_traffic_msgs/msg/detail/schedule_change_add__rosidl_typesupport_fastrtps_c.h"
...
#include "rmf_traffic_msgs/msg/detail/schedule_change_add_item__functions.h"  // items
...
using _ScheduleChangeAdd__ros_msg_type = rmf_traffic_msgs__msg__ScheduleChangeAdd;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ScheduleChangeAdd__ros_msg_type * ros_message = static_cast<const _ScheduleChangeAdd__ros_msg_type *>(untyped_ros_message);
  // Field name: plan_id
  {
  ...
  // Field name: items
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, rmf_traffic_msgs, msg, ScheduleChangeAddItem
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _ScheduleChangeAdd__ros_msg_type * ros_message = static_cast<_ScheduleChangeAdd__ros_msg_type *>(untyped_ros_message);
  // Field name: plan_id
  {
    cdr >> ros_message->plan_id;
  }
  ...
  // Field name: items
  {
    ...
    if (ros_message->items.data) {
      rmf_traffic_msgs__msg__ScheduleChangeAddItem__Sequence__fini(&ros_message->items);
    }
    if (!rmf_traffic_msgs__msg__ScheduleChangeAddItem__Sequence__init(&ros_message->items, size)) {
  ...
  size_t current_alignment)
{
  ...
  // field.name items
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_rmf_traffic_msgs__msg__ScheduleChangeAddItem(
...
static uint32_t _ScheduleChangeAdd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmf_traffic_msgs__msg__ScheduleChangeAdd(
  ...
  size_t current_alignment)
{
  ...
  // member: items
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_rmf_traffic_msgs__msg__ScheduleChangeAddItem(
...
static size_t _ScheduleChangeAdd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmf_traffic_msgs__msg__ScheduleChangeAdd(
...
static message_type_support_callbacks_t __callbacks_ScheduleChangeAdd = {
...
static rosidl_message_type_support_t _ScheduleChangeAdd__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ScheduleChangeAdd,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmf_traffic_msgs, msg, ScheduleChangeAdd)() {
  return &_ScheduleChangeAdd__type_support;
}
