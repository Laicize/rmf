...
#include "rmf_building_map_msgs/msg/detail/graph_edge__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const rmf_building_map_msgs::msg::GraphEdge *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rmf_building_map_msgs::msg::GraphEdge *>(
    untyped_ros_message);
...
{
  return &rmf_building_map_msgs::msg::typesupport_fastrtps_cpp::_GraphEdge__handle;
}
